    ...
    <form method="POST" action="{{route('todos.update',['todo'=>$todo->id])}}">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" id="exampleFormControlTextarea1" name="des" placeholder="Description......" style="max-width: 50%; margin-left: 463px;" rows="2" value="{{$todo->des}}">
